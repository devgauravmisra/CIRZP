    ...
    <div class="row">
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card card-signin my-5">
                <div class="card-body">
                    <h5 class="card-title text-center">Razorpay Integration in CI3</h5>
          ...
          <label for="subject">Amount <span style="color: #FF0000">*</span></label>
                       ...
                       <br/>
                        <button type="submit" name="sendMailBtn" class="btn btn-lg btn-primary btn-block text-uppercase" >Pay</button>
                    </form>
                </div>
            </div>
        </div>
